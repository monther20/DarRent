        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <ThemedCard style={styles.preferencesCard} colorName="card">
              ...
              <ThemedText style={styles.preferenceValue}>Downtown, West Side</ThemedText>
              <ThemedText style={styles.preferenceTitle}>Budget Range</ThemedText>
              <ThemedText style={styles.preferenceValue}>$800 - $1,200</ThemedText>
              <ThemedText style={styles.preferenceTitle}>Property Type</ThemedText>
              <ThemedText style={styles.preferenceValue}>Apartment, Condo</ThemedText>
            </ThemedCard>
          </View>
        </View>
      </ScrollView>
