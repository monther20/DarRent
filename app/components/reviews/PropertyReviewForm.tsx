...
// Rating categories for detailed property evaluation
const RATING_CATEGORIES = [
  { id: 'location', key: 'locationRating' },
  { id: 'cleanliness', key: 'cleanlinessRating' },
  { id: 'accuracy', key: 'accuracyRating' },
  { id: 'value', key: 'valueRating' },
  { id: 'communication', key: 'communicationRating' },
];
...
export const PropertyReviewForm = ({
  contractId,
  propertyId,
  propertyName,
  landlordId,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await mockApi.submitPropertyReview({
        contractId,
        propertyId,
        propertyName,
        reviewerId: 'current-user', // In a real app, get from auth context
        reviewerName: 'Current User', // In a real app, get from auth context
        overallRating,
        categoryRatings,
        reviewText,
        wouldRentAgain,
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <ThemedText style={styles.title}>{t('reviewProperty', { ns: 'reviews' })}</ThemedText>
      ...
      <View style={styles.contractInfo}>
        ...
        <View style={styles.infoRow}>
          <ThemedText style={styles.infoLabel}>{t('landlord', { ns: 'reviews' })}:</ThemedText>
          <ThemedText style={styles.infoValue}>{landlordName}</ThemedText>
        </View>
        <View style={styles.infoRow}>
      ...
      <View style={styles.section}>
        ...
        <TextInput
          ...
          placeholder={t('propertyReviewPlaceholder', { ns: 'reviews' })}
          multiline
          numberOfLines={5}
      ...
      <View style={styles.section}>
        ...
        <ThemedText style={styles.photoDescription}>
          {t('propertyPhotoDescription', { ns: 'reviews' })}
        </ThemedText>
      ...
      {showPolicy && (
        <View style={styles.policyContainer}>
          ...
          <ThemedText style={styles.policyText}>
            {t('propertyReviewPolicyText1', { ns: 'reviews' })}
          </ThemedText>
          <ThemedText style={styles.policyText}>
            {t('propertyReviewPolicyText2', { ns: 'reviews' })}
          </ThemedText>
          <ThemedText style={styles.policyText}>
            {t('propertyReviewPolicyText3', { ns: 'reviews' })}
          </ThemedText>
        </View>
      )}
