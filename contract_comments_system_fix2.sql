...
-- This file ensures the contract_comments table has the right structure and drops conflicting functions

-- ==========================================
-- Drop existing functions to avoid return type conflicts
-- ==========================================

-- Drop functions that might have changed return types
DROP FUNCTION IF EXISTS get_contract_issues_summary(text);
DROP FUNCTION IF EXISTS get_contracts_with_issue_summary(text);
DROP FUNCTION IF EXISTS add_contract_comment(text, text, text, text, text, text, boolean, text, text);
DROP FUNCTION IF EXISTS get_contract_comments(text, boolean);
